...
const InputField = ({ type, placeholder, value, onChange, required, icon, error, errorMessage }) => {
  ...
  const getDefaultStyles = () => ({
    borderColor: error ? "#ff6b6b" : "rgba(23, 15, 88, 0.2)",
  ...
  useEffect(() => {
    ...
    if (iconRef.current) {
      iconRef.current.style.color = error ? "#ff6b6b" : "rgba(23, 15, 88, 0.6)"
    }
  }, [error])
  ...
  const handleFocus = (e) => {
    ...
    if (iconRef.current) {
      iconRef.current.style.color = error ? "#ff6b6b" : "#FDCD00"
    }
  }
      ...
      {type === "password" && (
        <button
          ...
          style={{
            ...
            border: "none",
            cursor: "pointer",
            color: error ? "#ff6b6b" : "rgba(23, 15, 88, 0.6)",
            padding: "4px",
            display: "flex",
            alignItems: "center",
          ...
          onMouseEnter={(e) => {
            e.target.style.color = error ? "#ff6b6b" : "#FDCD00"
          }}
          onMouseLeave={(e) => {
            e.target.style.color = error ? "#ff6b6b" : "rgba(23, 15, 88, 0.6)"
          }}
        >
